...
协调至关重要。它将单一层面的努力与多方面成员的巨大任务联系在一起。协调允许一个人可能遇到的更大的任务越来越多。
...
在接受一项任务或计划的过程中，每一步都代表着简化、重新评估、质量保证和风险管理循环的停止。在我们的一生中，无论是有意识的还是无意识的，我们都日复一日地经历着这个循环。

从本质上讲，我们甚至学会了如何每次都以同样的方式完成一项与我们的需求互补的任务。为了确保我们也要求其他人进行有效的“协作”，或者以“整合”的形式领导另一个有技能的人或团体在此之前，每个人都有一个独特的特质。然而，随着任务或项目的范围超出一个人的能力，挑战随之而来。进一步克服这些限制将取决于合作与统一的结合。

这是一个标准的选择，其动力来自于“团结是解决最具挑战性的任务的最理想方式”的论调。然而，那些支持这种意识形态的人常常永远无法描绘出这两种奇点之间的区别。毫无疑问，两者既不相同也不完美。即便如此，两者各有利弊。通过考虑适当的情况，人们可以选择一种或另一种可能性。然而，在我进一步阐述之前，我们必须首先了解它们各自的定义缺乏语义变化，这种变化一直威胁着公众对它们本质的理解。

# 协作需要分散的调解

协作仅仅是两个或更多人的功能。它也可以指独立地承认为完成一项任务或达到一个目标而合作的机构。像巩固努力一样，合作需要领导；然而，如前所述，这种监督的结构更多的是一种协调和维持组织结构。

合作壮举的核心本质是去中心化的，没有单一的权威来支持最终的发言权。当面对有限资源的竞争时，协同运作的系统通常可以获得大量的资源、认可和回报。协作鼓励对行为和交流的沉思，从而在团队参与联合解决问题时增加团队的成功。非同寻常的合作被虚构地用于对立的目的，显示出对抗性合作的概念。

# 协作努力的本质

在它的应用理解中，协作是一种有意的关系，在这种关系中，所有各方战略性地自愿选择合谋来实现一个共享的结果。尽管有压倒性的理想，协作也伴随着某些缺点。所述陷阱的日常遭遇很少包括合作者中群体思维自动集合的发生率，其通过部分瓦解的方式助长歧视和偏见。人们通过团结一致来走捷径的情况并不少见。最新的服务就像为什么当前的系统通常依靠一致而不是合作的原因。

# 角色和责任不明确

协作网络成员之间的角色和职责可能会模糊不清。人们可能会把这种趋势完全说成是合作努力的缺点之一。然而，我必须强调分散领导或协调员在建立一个没有偏见、捆绑和责任感丧失的环境方面的重要性。

普遍的看法是，合作的成本可能很高

在群体内部发生冲突的情况下，这可能会导致更长的决策时间。同样，与协作相关的大多数缺点都有一个共同点——也就是说，只有一个领导或团队管理，这可能无法在团队成员之间建立足够的透明度和问责制。

# 整合缺乏灵活性

联合是将两个或两个以上的人或实体集中或统一起来作为一个独特的单位运作的过程。它需要对一个单一的、不可改变的使命有强烈的责任感，把它的各个组成部分，即人，联合起来。协作是方便的、激励性的，并且充分考虑到权威领导的存在。

在整合的系统中，领导的主要职能是维持团队的完整——系统中可能持有极端意识形态的个人的团结环境。在一个联盟的元素中寻找共同的价值是一项艰巨的任务，尤其是当单位规模很大的时候。交流越多，在他们之间建立共性就越有挑战性，因此更倾向于权威领导和独裁。那些支持统一的人将通过平衡领导权威和选民之间的共同点来证明这一壮举的合理性。

![](img/fc6dd41b29c210c70450a1a5bfa4da87.png)

威权主义是特定社区或群体意识形态多样性与规模比例增加的副产品。它为行政当局提供了一个机会来执行一个标准的操作程序，而不管其个人的独立信念。
...
集权会导致本土激情的不良后果。当有一个集中的数据库时，本地管理员的工作量通常会减少。反过来，该组织的等级制度可能会禁止当地领导人雇用他们的工人。一个集中的数据库限制了继任计划，仅仅是因为信息是中心的，因此对新主管的扩展要求很少的工作。
...
如果忽视了这一点，它还会在来自不同群体、具有同等影响力的本地管理者之间培养有害的竞争。因为他们知道他们有独立的决策角色，解决部门间的冲突可能会变得更加困难。除此之外，竞争的同级领导可能会拒绝协调和合作。
...
在线协作平台优化了文档安全性。在协作出口的范围内管理所有文档及其审阅，降低了正在进行的文档编辑或意外将敏感材料公之于众的可能性。
