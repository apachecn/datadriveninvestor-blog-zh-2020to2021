...
这就是区别所在。麻省理工学院的普通学生在能力上与我国中等水平大学的学生没有什么不同。区别在于同辈群体，以及你的同辈圈子里有多少人能接触到顶级的优质资源，以及你的同辈群体有多多样化。这种心态很重要，因为传统上，你的优点和能力不是由一个人的实际能力和对知识的追求来定义的，而是由他们在哪里学习和他们与谁有联系来定义的。随着越来越多的人转向在线教育，这种观念已经并将会被打破。这就是为什么像我这样有特权的人不需要 IIT 或 NIT。
...
> 一旦你找到了关于这篇论文的缺失环节，那么你就更容易完全理解这篇论文。如果你花了一周的时间去阅读一篇研究论文，这是没问题的。但是不要远离阅读新的研究论文和研究。
...
我从来不喜欢数学和生物。我尽可能地避开他们。

但我是编程的超级粉丝。当我高中毕业时，我在寻找一些随机的在线课程来开始学习一些新的东西。我偶然发现了哈佛大学 EdX 上的一门计算机科学(CS)入门课程，名为 CS50。出于无聊，我报了名，那门课的一个客座教授讲的是一个简单的公式，用来计算两点之间的距离，这个公式被称为欧几里德公式，是如何被用于计算机视觉(图像处理)的。我对编程的热情现在通过计算机视觉领域与数学相交。

突然，我对数学和计算机科学之间的交集产生了更多的兴趣，然后我开始观看麻省理工学院 18.06 课程，这是麻省理工学院关于线性代数的系列讲座和格兰特·桑德森的微积分课程，因为我知道数学的这两个分支构成了现代图像处理算法的基础。这些概念可以在电脑上编程，这就是为什么像图像压缩，网络流媒体，YouTube 上的推荐这样的东西是可能的。我希望在大学课程中学到更多这方面的知识，但在我的本科学位期间，我什么也没学到。我们在 PhospheneAI 所做的大部分工作都依赖于这两个数学领域，这与学校和大学里“用一本书解决一百个问题”的方法截然不同。

如果我仅仅因为 CS50 涉及数学就远离它，那么我就不会成为一名全栈开发人员。

如果你不喜欢某个科目，试着通过你喜欢的领域来观察其他领域，然后你就能开始喜欢你曾经讨厌的科目。我的一个大学同学想成为一名摄影师，他开始学习图像处理和编程，这样他就可以制作他的摄影工具。摄影(他喜欢的)和数学(他过去讨厌的)之间的交叉帮助他跨越了多个学科，并使他能够做他今天正在做的惊人的工作。

# 分散你的兴趣

如果没有开放的在线学习平台，这种策略是不可能实现的。

有时，当我不确定要报哪门课程时，我会尝试在 Coursera 或 EdX 上随机报一门课。这就是我如何理解我的兴趣在于一个非常多样化的光谱。我选修了经济学、气候变化、量子物理学、社会学、计算神经科学等课程，最近还选修了生物学。这些领域要么是我不感兴趣的，要么是我厌恶的。而是随意的报读这些课程并产生了兴趣。当然也有像数字信号处理，化学这些我曾经报过的，不太喜欢的领域，不过还好。如果你在探索过程中参加了某些课程，然后又退出了，这是没问题的。这是探索各种主题的一部分。

有一些生物学相关的课程，我两年前报了名，后来退出了。我真的以为我永远无法完成生物学课程，但最近，今年我注册了“麻省理工学院 7.00x:生物学导论:生命的秘密”，主要是因为埃里克·兰多教授教授生物学的方式和他在教学时的热情，我开始对这一领域产生兴趣。所以有时候并不是你不能对这个领域产生兴趣，而是你试图从不适合你的资源中学习。现在我注册了一些生物信息学课程，我非常喜欢它们。

> 顺便说一句，基因组学最权威的声音之一埃里克·兰多(Eric Landor)攻读了数学博士学位，然后偶然发现了基因组学，直到那时他才开始学习生物学。另一个在线开放学习可以帮助人们分散兴趣的例子。

我经常参加与我目前工作领域无关的课程。这些完全是随机的。任何人都可以对任何领域或学科产生兴趣；你只需要耐心去寻找各种资源，如果你因为对那个领域不感兴趣而辍学，这完全没关系。唯一重要的是你是否在越来越多地探索。

# 在你的同龄人中形成一个学习小组

对我来说，这是最好也是最被低估的方法之一，它对我和我的同伴都很有效。当我进入大学时，我明白许多人对他们的专业没有兴趣，但我能够理解每个人都有独特的天赋。当然，他们不得不为了完成大学学位而完成大学学位，但这并不意味着他们不需要学习如何从他们热爱的事情中获得职业。

不足为奇的是，他们提升潜力所需的资源在网上就能找到。我把这些平台介绍给了我的几个同龄人，慢慢地他们开始接受“无所不知”的心态，他们慢慢地把这些平台介绍给其他人，我们开始分享我们学到的东西(这是一个非常多样化的人群，有着不同的兴趣)，有时如果我们中的几个人碰巧参加了同一门课程，我们会分享不同的观点。这让我们能够理解不同的人是如何解释和理解同一个主题的，即使内容是相同的。

> 学习很棒，但与人一起学习更棒。相信我，如果你的同龄人似乎对学术甚至学习不感兴趣，试着讨论他们喜欢的领域，并指出有助于提高他们对该领域的知识的资源，然后发现他们突然对学习上瘾。

所以，是的。不要犹豫组建学习小组，尤其是在线学习。它帮助你和你的同龄人一起成长，你可以对不同或相同的内容获得不同的观点，这将极大地帮助你和你的同龄人。

# 不断学习

这是人们会觉得不现实的事情。我们的上一代人从来没有生活在这样一个世界里，我们这一代人一周消耗的信息量与我爸爸或妈妈这一代人，甚至是出生于 80 年代和 90 年代之间的人一年消耗的信息量是一样的。我并不是说他们能力较弱，而是说我们生活在一个非常不同的世界。他们与父母之间的代沟和信息鸿沟比我与父母之间的鸿沟要小得多。这就是世界的巨大变化。

现在，对于我这一代人来说，要想保持消息灵通，仅仅通过像 InShorts 这样的应用阅读新闻是不够的。对于我这样一个从小就对别人生活以外的一切充满好奇的人来说，在线学习相当容易。但是如果我没有在很小的时候接触到网上学习，我可能会很挣扎。但我在我的同龄人中看到，学习新事物的习惯是可以培养的，事实上，他们中许多讨厌持续学习的人现在通过在线课程、日志、ted 演讲等学习的速度比我快得多。

这个过程甚至会持续到我们 30 岁、40 岁甚至 50 岁。我打算在我一生中的任何时候至少注册一门在线课程。这将是困难的，因为我们是第一代被介绍到这种环境中的人，因此，我们没有一个如何在我们的一生中保持学习和探索的蓝图。

但是学习是有趣的，我已经多次提到，我们如何通过从不同的角度来看待不同的学科，使学习变得有趣。

我想就这样吧。你可以看看其他人在 medium 上的帖子中的其他技巧，但我只提到了我看过的其他帖子中没有提到的技巧。希望你觉得它有用，并分享帮助你成为更好的学习者的策略，我也会尝试它们。分享在学习中非常重要。
